...
def find_environment_file(start_path: Optional[str] = None) -> Optional[Path]:
...
def get_environment_name(env_data: Dict[str, Any]) -> Optional[str]:
...
def get_conda_environment_name(start_path: Optional[str] = None) -> Optional[str]:
